...
from app.api.v1.endpoints import projects, requirements, test_cases, test_runs, ai_engine, statistics, test_analysis, performance_tests
...
api_router.include_router(performance_tests.router, prefix="/performance-tests", tags=["performance-tests"])